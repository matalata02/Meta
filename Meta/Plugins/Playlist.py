...
from Meta import BOT_ID, BOT_USERNAME, MUSIC_BOT_NAME, SUDOERS, app, db_mem
from Meta.Database import (_get_playlists, delete_playlist, get_playlist,
                            get_playlist_names, save_playlist)
from Meta.Decorators.admins import AdminRightsCheck
...
from Meta.Inline import (add_genre_markup, check_genre_markup, check_markup,
...
/delmyplaylist
- Delete any saved in your playlist


/delgroupplaylist
- Delete any saved in your group's playlist [Requires Admin Rights.]
"""
