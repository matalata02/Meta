...
from Meta.Core.PyTgCalls.Meta import (pause_stream, resume_stream,
                                        skip_stream, skip_video_stream,
                                        stop_stream)
from Meta.Database import (is_active_chat, is_music_playing, music_off,
                            music_on, remove_active_chat,
                            remove_active_video_chat)
from Meta.Decorators.admins import AdminRightsCheck
from Meta.Decorators.checker import checker, checkerCB
from Meta.Inline import audio_markup, primary_markup, secondary_markup2
