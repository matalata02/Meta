...
from Meta.Core.Clients.cli import (ASS_CLI_1, ASS_CLI_2, ASS_CLI_3, ASS_CLI_4,
                                    ASS_CLI_5, LOG_CLIENT, app)
from Meta.Utilities.changers import time_to_seconds
from Meta.Utilities.tasks import install_requirements
...
async def initiate_bot():
    ...
    header.add_column(
        "\x41\x79\x69\x69\x6e\x20\x4d\x75\x73\x69\x63\x20\x3a\x20\x54\x68\x65\x20\x4d\x6f\x73\x74\x20\x41\x64\x76\x61\x6e\x63\x65\x64\x20\x4d\x75\x73\x69\x63\x20\x42\x6f\x74"
    )
