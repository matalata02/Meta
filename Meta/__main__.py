...
from Meta.Core.Clients.cli import LOG_CLIENT
from Meta.Core.PyTgCalls.Meta import (pytgcalls1, pytgcalls2, pytgcalls3,
...
async def initiate_bot():
    ...
    console.print(
        "[bold green]Congrats!! Mate has started successfully!\n"
    )
    try:
        await app.send_message(
            LOG_GROUP_ID,
            "<b>Congrats!! Mate has started successfully!</b>",
        )
    except Exception as e:
        print(
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("sadnesstalk")
            await ASS_CLI_1.join_chat("sadnesstalk")
            await ASS_CLI_1.join_chat("sadnesstalk")
        except:
            pass
    ...
    if STRING2 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_2.join_chat("sadnesstalk")
            await ASS_CLI_2.join_chat("sadnesstalk")
            await ASS_CLI_2.join_chat("sadnesstalk")
        except:
            pass
    ...
    if STRING3 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_3.join_chat("sadnesstalk")
            await ASS_CLI_3.join_chat("sadnesstalk")
            await ASS_CLI_3.join_chat("sadnesstalk")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_4.join_chat("sadnesstalk")
            await ASS_CLI_4.join_chat("sadnesstalk")
            await ASS_CLI_4.join_chat("sadnesstalk")
        except:
            pass
    ...
    if STRING5 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_5.join_chat("sadnesstalk")
            await ASS_CLI_5.join_chat("sadnesstalk")
            await ASS_CLI_5.join_chat("sadnesstalk")
        except:
            pass
...
My name is {BOT_NAME}.
A Telegram bot with some useful features.
